    ...
    <section className="relative min-h-screen flex items-center justify-center pt-8 pb-32">      
      <div className="relative max-w-7xl mx-auto px-6 py-12 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <button className="group w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-400 hover:to-emerald-500 text-black font-semibold rounded-xl transition-all duration-200 shadow-xl shadow-green-500/30 flex items-center justify-center gap-3">
